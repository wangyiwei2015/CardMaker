...
struct CardDesign {
    ...
    static let empty = CardDesign(date: 0, title: NSLocalizedString("Tap to edit", comment: ""), titleSizeId: 0, titleFontName: "PingFangSC-Regular", titleColorId: 6, bgColorId: 2, mood: "🫥", imgStyle: 0, dateStyle: 0, dateOpacityId: 2, dateColorId: 2, datePosition: 0, showYear: false, yearBottom: true)
}
